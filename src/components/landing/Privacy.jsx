...
const definition = [
	...
	"Application: The software program provided by the Company downloaded by You on any electronic device, named Giftly.",
	`Company: (referred to as either "the Company," "We", "Us," or "Our" in this Agreement) refers to Giftly.me, 1309 Coffeen Avenue STE 1200, Sheridan, Wyoming, 82801.`,
	...
	"Website: refers to Giftly, accessible from http://giftly.me",
...
const personalData = [
	...
	"Google",
	" Suppose You decide to register through or otherwise grant us access to a Third-Party Social Media Service; in that case, We may collect Personal data that is already associated with Your Third-Party Social Media Service's account, such as Your name, Your email address, Your activities, or Your contact list associated with that account.",
	...
	"The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies. The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period, except when this data is used to strengthen the security or improve the functionality of Our Service. We are legally obligated to retain this data for longer periods.",
...
const childrensPrivacy = [
    "Our Service does not address anyone under the age of 13. We do not knowingly collect personally identifiable information from anyone under the age of 13. If You are a parent or guardian and know that Your child has provided Us with Personal Data, please contact Us.",
    "Suppose We become aware that We have collected Personal Data from anyone under the age of 13 without verification of parental consent; in that case, We take steps to remove that information from Our servers.",
...
const changeToPrivacy = [
	...
	"You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective immediately they are posted on this page."
]
const contactUs = [
	...
	return (
		<Wrapper>
			...
			{privacyPolicy.privacy.map((ele) => (
				<p className="priv1" key={ele}>{ele}</p>
			))}
			...
			{privacyPolicy.personalData.map((ele,index)=><p key={ele}>{ele}</p>)}

			<h3>Children's Privacy </h3>
			{privacyPolicy.changeToPrivacy.map((ele,index)=><p key={ele}>{ele}</p>)}

			<h3>Links to Other Websites</h3>
			{privacyPolicy.linkToWebsite.map((ele,index)=><p key={ele}>{ele}</p>)}

			<h3> Changes to this Privacy Policy</h3>
			{privacyPolicy.changeToPrivacy.map((ele,index)=><p key={ele}>{ele}</p>)}

			<h3>Contact Us</h3>
			{privacyPolicy.contactUs.map((ele,index)=><p key={ele}>{ele}</p>)}
