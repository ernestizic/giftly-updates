...
const FAQS = [
	...
	},
	{
		...
		answer: "No, you don't need to input a link for an item. It is, however, advisable to add a link if you can. Adding a link will make the purchasing process easy for your friends. ",
	},
	{
		question: "Do my friends need a Giftly account to view my wish list?",
		answer: "No, your friends do not have to be on Giftly to view and claim items on your wish list. ",
	},
	{
		question: "Do I have to drop the URL of an item?",
		answer: "You can choose to delete a wish list you no longer require. You can also edit the details of the wish list. ",
	},
	...
	},
	{
		...
		answer: "You can create a wish list for several occasions, including but not limited to; birthdays, baby and bridal showers, Secret Santa, private get-togethers, to mention a few. ",
	},
];
...
const FAQs = () => {
	return (
        ...
        <div className="faqs">
              ...
              <div className="links">
                <Link to="/user">Terms of use</Link>
                <Link to="/user">new-wishlist</Link>
                <Link to="/user">FAQ</Link>
              </div>
      </div>
